...
<c:choose>
    <c:when test="${empty cartItemList }">
        <table width="95%" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td align="right">
                    <img align="top" src="<c:url value='/image/icon_empty.png'/>"/>
                </td>
                <td>
    ...
    <c:otherwise>
            ...
            <c:forEach items="${cartItemList }" var="cartItem">
                <tr align="center">
                    ...
                    <td align="left" width="70px">
                        <a class="linkImage" href="<c:url value='food.jsp'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.goods.image_a }'/>"/></a>
                    </td>
                    <td align="left" width="400px">
                        <a href="<c:url value='food.jsp'/>"><span>${cartItem.goods.gname }</span></a>
                    </td>
                    <td><span>&yen;<span class="price">${cartItem.goods.price }</span></span></td>
                    <td>
        ...
        <form id="jieSuanForm" action="<c:url value='index.jsp'/>" method="post">
