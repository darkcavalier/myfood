...
public class CartItemDao {
    ...
    public List<CartItem> loadCartItems(String cartItemIds) throws SQLException {
		 ...
		 * 3. 生成sql语句
		 */
        String sql = "select * from t_cartitem c, t_goods b where c.gid=b.gid and " + whereSql;
		/*
    ...
    public CartItem findByCartItemId(String cartItemId) throws SQLException {
        String sql = "select * from t_cartItem c, t_goods b where c.gid=b.gid and c.cartItemId=?";
    ...
    public List<CartItem> findByUser(String uid) throws SQLException {
        String sql = "select * from t_cartitem c, t_goods b where c.gid=b.gid and uid=? order by c.orderBy";
