...
<script type="text/javascript">
  ...
  <jsp:include page="head.jsp"></jsp:include>
	<div class="main">
	  <div><img src="<c:url value='/image/wlogo.png'/>" /></div>
	  <div>
	    <%--<div class="imageDiv"><img class="img" src="<c:url value='/image/zj.png'/>"/></div>--%>
            <div class="imageDiv"></div>
        <div class="login1">
	      <div class="login2">
            <div class="loginTopDiv">
              <span class="loginTop">我厨会员登录</span>
              <span>
                <a href="<c:url value='register.jsp'/>" class="registBtn"></a>
              </span>
            </div>
            <div>
                ...
                <input type="hidden" name="method" value="login" />
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <img id="vCode" src="<c:url value='/VerifyCodeServlet'/>"/>
                          <label><a href="javascript:_hxz()">换一张</a> </label>
                      </td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td align="left">
                        <input type="image" id="submit" src="<c:url value='/image/login1.jpg'/>" class="loginBtn"/>
                      </td>
                    </tr>																				
                 </table>
              </form>
